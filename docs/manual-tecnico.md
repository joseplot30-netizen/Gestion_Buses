...
- Backend dual:
  ...
  - FastAPI en Python (API REST, manipulación de datos de buses e incidentes, y operaciones de CRUD).
- Base de datos: MySQL (`proyectobbdd`, `buses`, `users`, `reportes_incidentes`, `destinos`, `users_admin`).
