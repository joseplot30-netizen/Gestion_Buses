...
## 1) Acceso
1. Abrir navegador e ir a `http://localhost/Proyecto Node.js+PHP+MySql/frontend/public/index.html`.
2. Ingresar Usuario/Código de unidad y contraseña.
3. Si es administrador, será redirigido a `admin.php`.
4. Si es chofer, será redirigido a `bus_status.php`.
